#code for analyzing only one stock, next will analyze all 4 stockxx
...
# Step 1: Read the .txt file (assuming it's CSV-formatted)
df = pd.read_csv("aapl_stock.txt")

# Step 2: Save to .csv
df.to_csv("aapl.us.csv", index=False)

print("Conversion complete! Saved as aapl.us.csv")
